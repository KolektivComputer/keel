...
The sample below is Svelte (`page()`, `<Head />`). Use the navbar frontend picker for the matching adapter API (`usePage`, `injectKeelPage`, and so on). See <a href={path("/docs/implementing/framework-adapters")}>Framework adapters</a>.
</FrameworkPanel>
